...
### 백업
>• 50mb 이하의 파일을 업로드 가능하며, 파일 디렉토리를 생성 할 수 있음
>
>• 압축파일을 업로드시 압축해제가 되며 텍스트 파일 형식은 미리 보기가 가능
...
>• 이메일과 비밀번호로 로그인
>
>•  ‘email 기억하기’ 체크크박스 선택시 쿠키로 이메일을 기억
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU1MTAwMTE0LC04MTcxODUwODIsNjE0MT
I5MzkwLC0yNjQ0NzM2MDEsLTEyOTMwNjA2NzQsMjcyOTgwMzI3
XX0=
-->